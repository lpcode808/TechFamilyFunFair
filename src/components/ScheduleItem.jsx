...
export default function ScheduleItem({ item }) {
  ...
  return (
    <div className="border rounded-lg mb-3 overflow-hidden bg-white dark:bg-dark-card dark:border-gray-700">
      <div 
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400 flex items-center">
                <MapPinIcon className="w-4 h-4 mr-1 inline dark:text-gray-400" />
                {item.location}
              </p>
            </div>
          </div>
      ...
      {expanded && (
        <div className="border-t p-4 bg-gray-50 dark:bg-dark-secondary dark:border-gray-700">
          {item.speaker && (
            <div className="flex items-center mb-2">
              <UserIcon className="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400" />
              <span className="text-sm dark:text-gray-300">{item.speaker}</span>
            </div>
          )}
          <div className="flex items-center">
            <ClockIcon className="w-4 h-4 mr-2 text-gray-500 dark:text-gray-400" />
            <span className="text-sm dark:text-gray-300">{item.time}</span>
          </div>
          <div className="mt-2">
