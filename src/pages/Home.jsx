  ...
  const SocialButton = ({ type, url = "#" }) => {
    ...
    return (
      <a 
        ...
        className="px-4 py-2 rounded-lg bg-[#004299] dark:bg-dark-primary text-white dark:text-white text-sm font-medium hover:bg-[#00306d] dark:hover:bg-dark-primary-hover transition-colors inline-block text-center min-w-[90px]"
  ...
  return (
    <div className="container mx-auto px-4 pb-20">
      ...
      <div className="pt-12 py-8 text-center">
        <h1 className="text-3xl font-bold text-[#004299] dark:text-dark-primary">Tech & Family Fun Fair</h1>
        <p className="mt-2 text-gray-600 dark:text-gray-300">La Pietra Hawai'i School for Girls</p>
        <p className="text-gray-600 dark:text-gray-300">March 9, 2025 • 10am - 2pm</p>
      </div>
      
      {/* Event Details */}
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
        <h2 className="text-xl font-bold text-[#004299] dark:text-dark-primary mb-2">Event Details</h2>
      ...
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-[#004299] dark:text-dark-primary">Food Vendors</h2>
        </div>
      ...
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-[#004299] dark:text-dark-primary">Experiences</h2>
          <Link to="/experiences" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm">
        ...
        <div className="mt-4">
          <Link 
            to="/experiences" 
            className="inline-block bg-[#004299] dark:bg-dark-primary text-white py-2 px-4 rounded hover:bg-[#00306d] dark:hover:bg-dark-primary-hover transition-colors"
          >
            Browse Experiences
          </Link>
        </div>
      ...
      <div className="bg-white dark:bg-dark-card rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-[#004299] dark:text-dark-primary">Merchandise</h2>
          <Link to="/vendors" className="text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 text-sm">
